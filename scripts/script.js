...
let fontscroll = document.querySelector(".font"); //للخط تحت الهيدر
let height = document.documentElement.scrollHeight - document.documentElement.clientHeight; //متحول
window.addEventListener("scroll", () => {
